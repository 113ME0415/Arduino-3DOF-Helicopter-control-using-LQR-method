//LQR control method for regulating the Quansers 3DOF Helicopter
...
// counterweight is positioned at 2nd slot.
...
// Feedback gains or LQR gains
const float k11= 4.472;                           
const float k12= 35.478;
const float k13= -12.247;
const float k14= 7.234;
const float k15= 7.8314;
const float k16= -11.442;
const float k21= k11;
const float k22= -k12 ;
const float k23= -k13 ;
const float k24= k14;
...
void loop() 
{
   ...
   //  Serial.print(" z2: "); 
    ...
    U1 = -(x1*k11+y1*k12+z1*k13+x2*k14+y2*k15+z2*k16)+7.5;
    U2 = -(x1*k21+y1*k22+z1*k23+x2*k24+y2*k25+z2*k26)+7.5;
   ...
   // Serial.print("Controller2: "); 
    ...
    // We need to mention the voltage limits.
    ...
    unsigned long currentMillis10 = millis();   // Gives current time in ms
    unsigned long TS= currentMillis10- currentMillis; 
  //  Serial.println(TS);   // time in milli seconds for one complete loop
